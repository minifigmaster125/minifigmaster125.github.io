...
There is a lot of advice about how to find the right game idea, with "right" generally implying that the game achieves some success metric that can justify the resources that went into making it. Ultimately, the claim of "right" can only be made in retrospect, after the game has actually met or exceeded the expectations laid out for it. Since I am at the beginning, I am here to discuss how I have arrived at my next game idea. It's righteousness will be discovered much later <sup>1</sup>. 
