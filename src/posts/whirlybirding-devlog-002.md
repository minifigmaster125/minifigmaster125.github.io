...
While tweaking the lay of the level, I encountered friction. Each change of a branch and tune of a hitbox was an exercise in alt-tabbing between Godot, Blender, and the actual running game. I didn't know what part of the process should be done where — none of my previous games had 3D platforming levels and it showed. Uncertainty brought in its grunts (where's the ref?), who started going at my legs with insults thinly veiled as questions. "Do you even have a level-design workflow?" "Are you seriously making your collisions in the engine instead of in Blender?" They were annoying, but I suppose they had a point.
